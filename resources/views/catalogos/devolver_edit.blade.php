    ...
    <div class="panel-body">
        <form method="post" action="{{ action('Catalogos\FichaController@devolver',['oFicha'=>$items]) }}">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-10">
                    {{ Form::date('fecha_salida',$items->fecha_salida, ['id'=>'fecha_salida','class'=>'col-md-3','readonly'=>'readonly']) }}
            ...
            <div class="form-group row">
                ...
                <div class="col-md-10">
                    {{ Form::date('fecha_devolucion',$items->fecha_entrega, ['id'=>'fecha_devolucion','class'=>'col-md-3']) }}
