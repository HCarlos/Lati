                                    ...
                                    <tr>
                                        ...
                                        <td width="100">
                                            ...
                                            @if ($user->hasAnyPermission(['subir_imagen_fichas','all']))
                                                <a href="{{ route('catalogosSubirImagenFichas/', array('id' => $id,'idItem' => $item->id,'action' => 4)) }}" class="btn btn-link btn-xs  margen-izquierdo-1em pull-right" title="Subir imagen" >
                                                    <i class="fas fa-image orange"></i>
                                                </a>
                                            @endif
                                            @if ($user->hasAnyPermission(['clonar_fichas','all']))
                                                <a href="{{ route('catalogosFichasClone/', array('id' => $id,'idItem' => $item->id,'action' => 3)) }}" class="btn btn-link btn-xs  margen-izquierdo-1em pull-right" title="Clonar" >
